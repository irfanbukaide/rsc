...
var handleBasicChart=function() {
    ...
    handleStackedChart=function() {
        ...
        $.plot("#stacked-chart", R, {
                xaxis: {
                    tickColor: COLOR_GREY_LIGHTER, ticks: [[0, "MON"], [1, "TUE"], [2, "WED"], [3, "THU"], [4, "FRI"], [5, "SAT"]], autoscaleMargin: .05
                }
                , yaxis: {
                    tickColor: COLOR_GREY_LIGHTER, ticksLength: 5
                }
                , grid: {
                    hoverable: !0, tickColor: COLOR_GREY_LIGHTER, borderWidth: 1, borderColor: COLOR_GREY_LIGHTER, backgroundColor: COLOR_SILVER_LIGHTER
                }
                , series: {
                    stack:!0, lines: {
    ...
    handleTrackingChart=function() {
        ...
        if(0!==$("#tracking-chart").length) {
            var e=$.plot($("#tracking-chart"), [ {
                    ...
                    , grid: {
                        hoverable: !0, autoHighlight: !1, borderColor: COLOR_GREY_LIGHTER, borderWidth: 1, backgroundColor: COLOR_SILVER
                    }
                    , yaxis: {
    ...
    handleInteractiveChart=function() {
        ...
        if(0!==$("#interactive-chart").length) {
            ...
            $.plot($("#interactive-chart"), [ {
                    ...
                    , grid: {
                        hoverable: !0, clickable: !0, tickColor: COLOR_BLACK_TRANSPARENT_3, borderWidth: 1, borderColor: COLOR_BLACK_TRANSPARENT_2, backgroundColor: COLOR_SILVER_LIGHTER
                    }
                    , legend: {
                        noColumns: 1, show: !0
                    }
