...
var handleVectorMap = function () {
    ...
    0 !== $("#world-map").length && $("#world-map").vectorMap({
        ...
        hoverColor: !1,
        zoomOnScroll: !1,
        markerStyle: {initial: {fill: COLOR_GREEN, stroke: "transparent", r: 3}},
        regionStyle: {
            initial: {
        ...
        markers: [{latLng: [41.9, 12.45], name: "Vatican City"}, {
            ...
            latLng: [15.3, -61.38],
            name: "Dominica"
        }, {latLng: [-20.2, 57.5], name: "Mauritius"}, {latLng: [26.02, 50.55], name: "Bahrain"}, {
            latLng: [.33, 6.73],
    ...
    if (0 !== $("#interactive-chart").length) {
        var e = [[1, 40], [2, 50], [3, 60], [4, 60], [5, 60], [6, 65], [7, 75], [8, 90], [9, 100], [10, 105], [11, 110], [12, 110], [13, 120], [14, 130], [15, 135], [16, 145], [17, 132], [18, 123], [19, 135], [20, 150]],
            i = [[1, 10], [2, 6], [3, 10], [4, 12], [5, 18], [6, 20], [7, 25], [8, 23], [9, 24], [10, 25], [11, 18], [12, 30], [13, 25], [14, 25], [15, 30], [16, 27], [17, 20], [18, 18], [19, 31], [20, 23]],
            t = [[1, ""], [2, ""], [3, "May&nbsp;15"], [4, ""], [5, ""], [6, "May&nbsp;19"], [7, ""], [8, ""], [9, "May&nbsp;22"], [10, ""], [11, ""], [12, "May&nbsp;25"], [13, ""], [14, ""], [15, "May&nbsp;28"], [16, ""], [17, ""], [18, "May&nbsp;31"], [19, ""], [20, ""]];
        ...
        $("#interactive-chart").bind("plothover", function (e, i, t) {
            if ($("#x").text(i.x.toFixed(2)), $("#y").text(i.y.toFixed(2)), t) {
                if (l !== t.dataIndex) {
                    ...
                    var n = t.datapoint[1].toFixed(2), o = t.series.label + " " + n;
                    a(t.pageX, t.pageY, o)
                }
    ...
    if (0 !== $("#donut-chart").length) {
        var a = [{label: "Chrome", data: 35, color: COLOR_PURPLE_DARKER}, {
            label: "Firefox",
            data: 30,
            color: COLOR_PURPLE
        ...
        $.plot("#donut-chart", a, {series: {pie: {innerRadius: .5, show: !0, label: {show: !0}}}, legend: {show: !0}})
    }
