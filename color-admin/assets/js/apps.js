...
var floatSubMenuTimeout, targetFloatMenu, handleSlimScroll = function () {
    ...
    if (!$(e).attr("data-init")) {
        var a = $(e).attr("data-height"), t = {height: a = a || $(e).height()};
    ...
    $(".sidebar .nav > .has-sub > a").click(function () {
        var a = $(this).next(".sub-menu"), e = $(".sidebar .nav > li.has-sub > .sub-menu").not(a);
    ...
    $(".sidebar").bind("click touchstart", function (e) {
        ...
        e.stopPropagation();
        var a = "#page-container", t = "page-right-sidebar-collapsed";
        ...
        e.stopPropagation();
        var a = "page-sidebar-toggled", t = "#page-container";
    ...
    "use strict";
    var e = "", a = "", t = handleCheckBootstrapVersion();
    3 <= t && t < 4 ? (e = "hide", a = "in") : 4 <= t && t < 5 && (e = "d-none", a = "show"), $(window).on("load", function () {
    ...
    panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function (e) {
        ...
        e.preventDefault();
        var a = $(this).closest(".panel"), t = $(a).find(".panel-body"), n = 40;
        if (0 !== $(t).length) {
            var o = $(a).offset().top;
            n = $(t).offset().top - o
        }
        if ($("body").hasClass("panel-expand") && $(a).hasClass("panel-expand")) $("body, .panel").removeClass("panel-expand"), $(".panel").removeAttr("style"), $(t).removeAttr("style"); else if ($("body").addClass("panel-expand"), $(this).closest(".panel").addClass("panel-expand"), 0 !== $(t).length && 40 != n) {
            var i = 40;
    ...
    $(e).sortable({
        handle: ".panel-heading", connectWith: ".row > [class*=col]", stop: function (e, a) {
    ...
    "use strict";
    var e = handleCheckBootstrapVersion(), a = "";
    3 <= e && e < 4 ? a = "in" : 4 <= e && e < 5 && (a = "show"), $(document).scroll(function () {
    ...
    if ($(document).on("change", ".theme-panel [name=direction]", function () {
    ...
    $(document).on("change", ".theme-panel [name=sidebar-fixed]", function () {
        ...
        }) : 979 < $(window).width() && ($('.sidebar [data-scrollbar="true"]').slimScroll({destroy: !0}), $('.sidebar [data-scrollbar="true"]').removeAttr("style"), $('.sidebar [data-scrollbar="true"]').removeAttr("data-init"))), 0 === $("#page-container .sidebar-bg").length && $("#page-container").append('<div class="sidebar-bg"></div>'))
    ...
    if (0 !== $(".ui-sortable").length) {
        ...
        $.when($(".ui-sortable").each(function () {
            ...
            e = (e = e.split("?"))[0], localStorage.setItem(e, JSON.stringify(t)), $(a).find('[data-id="title-spinner"]').delay(500).fadeOut(500, function () {
                $(this).remove()
            })
        })
    }
    ...
    function a(e, a) {
        var t = $(e).closest(".tab-overflow"), n = $("body").hasClass("rtl-mode") ? "margin-right" : "margin-left",
            o = parseInt($(t).find(".nav.nav-tabs").css(n)), i = $(t).width(), s = 0, l = 0;
        switch ($(t).find("li").each(function () {
            $(this).hasClass("next-button") || $(this).hasClass("prev-button") || (s += $(this).width())
        }), a) {
            case"next":
                (r = s + o - i) <= i ? (l = r - o, setTimeout(function () {
                    $(t).removeClass("overflow-right")
                }, 150)) : l = i - o - 80, 0 !== l && ($("body").hasClass("rtl-mode") ? $(t).find(".nav.nav-tabs").animate({marginRight: "-" + l + "px"}, 150, function () {
                    $(t).addClass("overflow-left")
                }) : $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + l + "px"}, 150, function () {
                    $(t).addClass("overflow-left")
                }));
                break;
            case"prev":
                var r;
                (r = -o) <= i ? ($(t).removeClass("overflow-left"), l = 0) : l = r - i + 80, $("body").hasClass("rtl-mode") ? $(t).find(".nav.nav-tabs").animate({marginRight: "-" + l + "px"}, 150, function () {
        ...
        $(".tab-overflow").each(function () {
            !function (e, a) {
                ...
                var n = $("body").hasClass("rtl-mode") ? "margin-right" : "margin-left",
                    o = (parseInt($(e).css(n)), $(e).width()), i = $(e).find(t).width(), s = -1 < a ? a : 150, l = 0;
                if ($(e).find(t).prevAll().each(function () {
                    ...
                    var r = i - o;
                    l != i && (r += 40), $("body").hasClass("rtl-mode") ? $(e).find(".nav.nav-tabs").animate({marginRight: "-" + r + "px"}, s) : $(e).find(".nav.nav-tabs").animate({marginLeft: "-" + r + "px"}, s)
                }
    ...
    function a(e, a) {
        var t = $(e).closest(".nav"), n = $("body").hasClass("rtl-mode") ? "margin-right" : "margin-left",
            o = parseInt($(t).css(n)), i = $(".top-menu").width() - 88, s = 0, l = 0;
        switch ($(t).find("li").each(function () {
            $(this).hasClass("menu-control") || (s += $(this).width())
        }), a) {
            case"next":
                (r = s + o - i) <= i ? (l = r - o + 128, setTimeout(function () {
                    $(t).find(".menu-control.menu-control-right").removeClass("show")
                }, 150)) : l = i - o - 128, 0 !== l && ($("body").hasClass("rtl-mode") ? $(t).animate({marginRight: "-" + l + "px"}, 150, function () {
            ...
            case"prev":
                var r;
                (r = -o) <= i ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), l = 0) : l = r - i + 88, $("body").hasClass("rtl-mode") ? $(t).animate({marginRight: "-" + l + "px"}, 150, function () {
    ...
    function e() {
        var e = $(".top-menu .nav"), a = $(".top-menu .nav > li"), t = $(".top-menu .nav > li.active"),
            n = $(".top-menu"), o = $("body").hasClass("rtl-mode") ? "margin-right" : "margin-left",
            i = (parseInt($(e).css(o)), $(n).width() - 128), s = $(".top-menu .nav > li.active").width(), l = 0;
        ...
        s != l && i <= l ? $(e).find(".menu-control.menu-control-right").addClass("show") : $(e).find(".menu-control.menu-control-right").removeClass("show"), i <= s && i <= l ? $(e).find(".menu-control.menu-control-left").addClass("show") : $(e).find(".menu-control.menu-control-left").removeClass("show")
    }
    ...
    $('[data-toggle="nav-profile"]').click(function (e) {
        e.preventDefault();
        var a = $(this).closest("li"), t = $(".sidebar .nav.nav-profile"), n = "expanding", o = "closing";
        $(t).is(":visible") ? ($(a).removeClass("active"), $(t).removeClass(o)) : ($(a).addClass("active"), $(t).addClass(n)), $(t).slideToggle(i, function () {
    ...
    $(document).on("click", "#float-sub-menu li.has-sub > a", function (e) {
        var a = $(this).next(".sub-menu"), t = $(a).closest("li"), r = !1, d = !1;
        $(a).is(":visible") ? ($(t).addClass("closing"), r = !0) : ($(t).addClass("expanding"), d = !0), $(a).slideToggle({
            duration: 250,
            progress: function () {
                var e = $("#float-sub-menu"), a = $(e).height(), t = $(e).offset(), n = $(e).attr("data-offset-top"),
                    o = $(e).attr("data-menu-offset-top"), i = t.top - $(window).scrollTop(), s = $(window).height();
                if (r && n < i && (i = n < i ? n : i, $("#float-sub-menu").css({
                    ...
                    top: "20px",
                    bottom: "auto"
                }), $("#float-sub-menu-line").css({top: "20px", bottom: "auto"})), d && s - i < a) {
                    var l = s - o - 22;
                    $("#float-sub-menu").css({top: "auto", bottom: 0}), $("#float-sub-menu-arrow").css({
                        top: "auto",
                        bottom: l + "px"
                    }), $("#float-sub-menu-line").css({top: "20px", bottom: l + "px"})
                }
            },
            complete: function () {
        ...
        if ($("#page-container").hasClass("page-sidebar-minified")) {
            ...
            if (a) {
                var t = $("#sidebar").offset(),
                    ...
                    o = $(e).height(), i = $(this).offset().top - $(window).scrollTop(),
                    s = $("#page-container").hasClass("page-with-right-sidebar") ? "auto" : n,
                    l = $("#page-container").hasClass("page-with-right-sidebar") ? n : "auto", r = $(window).height();
                if (0 === $("#float-sub-menu").length ? (a = '<div class="float-sub-menu-container" id="float-sub-menu" data-offset-top="' + i + '" data-menu-offset-top="' + i + '" onmouseover="handleMouseoverFloatSubMenu(this)" onmouseout="handleMouseoutFloatSubMenu(this)">\t<div class="float-sub-menu-arrow" id="float-sub-menu-arrow"></div>\t<div class="float-sub-menu-line" id="float-sub-menu-line"></div>\t<ul class="float-sub-menu">' + a + "</ul></div>", $("#page-container").append(a)) : ($("#float-sub-menu").attr("data-offset-top", i), $("#float-sub-menu").attr("data-menu-offset-top", i), $(".float-sub-menu").html(a)), o < r - i) $("#float-sub-menu").css({
                    ...
                    top: "20px",
                    bottom: "auto"
                }), $("#float-sub-menu-line").css({top: "20px", bottom: "auto"}); else {
                    $("#float-sub-menu").css({bottom: 0, top: "auto", left: s, right: l});
                    var d = r - i - 21;
                    $("#float-sub-menu-arrow").css({
                        top: "auto",
                        bottom: d + "px"
                    }), $("#float-sub-menu-line").css({top: "20px", bottom: d + "px"})
                }
...
}, CLEAR_OPTION = "", handleAjaxMode = function (c) {
    ...
    function a(e, a, t) {
        ...
        var s = "#content", l = e.replace("#", ""), r = c.ajaxType ? c.ajaxType : "GET",
            d = c.ajaxDataType ? c.ajaxDataType : "html";
        a && (d = $(a).attr("data-type") ? $(a).attr("data-type") : d, targetDataDataType = $(a).attr("data-data-type") ? $(a).attr("data-data-type") : d), $.ajax({
            url: l,
            type: r,
            dataType: d,
            success: function (e) {
    ...
    "" === (e = window.location.hash ? window.location.hash : e) ? $("#content").html(h) : a(e, "", !0), $(window).on("hashchange", function () {
    ...
    return {
        init: function (e) {
            ...
            (!a || a && !a.disableDraggablePanel) && handleDraggablePanel(), handleIEFullHeightContent(), handleSlimScroll(), handleUnlimitedTabsRender(), handlePanelAction(), handelTooltipPopoverActivation(), handleScrollToTopButton(), handleAfterPageLoadAddClass(), handlePageScrollClass()
